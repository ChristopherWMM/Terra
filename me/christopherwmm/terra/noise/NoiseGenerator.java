...
public abstract class NoiseGenerator<T extends Noise> extends Generator<T> {
	/**
	 * Generates the T value for the specified x and y coordinates based on the specific corresponding parameters entered into this {@link NoiseGenerator} object.
	 * 
	...
	/**
	 * Generates the 2D array of T value for the specific corresponding parameters entered into this {@link NoiseGenerator} object.
	 * 
	 * @return The 2D array of T value corresponding to the entered parameters.
	 * @since 1.0
	 */
